# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/doclinks.ipynb.

# %% auto 0
__all__ = ['patch_name', 'nbglob', 'nbglob_cli', 'nbdev_export', 'NbdevLookup']

# %% ../nbs/doclinks.ipynb 2
from .config import *
from .maker import *
from .export import *
from .imports import *
...
# %% ../nbs/doclinks.ipynb 19
import importlib,ast
from functools import lru_cache

# %% ../nbs/doclinks.ipynb 22
def _find_mod(mod):
...
# %% ../nbs/doclinks.ipynb 25
_re_backticks = re.compile(r'`([^`\s]+)`')

# %% ../nbs/doclinks.ipynb 26
@lru_cache(None)
class NbdevLookup:
