...
# %% auto 0
__all__ = ['populate_language', 'insert_warning', 'cell_lang', 'add_show_docs', 'filter_fm', 'construct_fm', 'infer_frontmatter',
           'nbflags_', 'add_links', 'strip_ansi', 'strip_hidden_metadata', 'hide_', 'hide_line', 'filter_stream_',
