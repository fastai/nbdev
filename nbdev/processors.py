...
# %% auto 0
__all__ = ['nbflags_', 'cell_lang', 'add_links', 'strip_ansi', 'strip_hidden_metadata', 'hide_', 'hide_line', 'filter_stream_',
           'clean_magics', 'lang_identify', 'rm_header_dash', 'rm_export', 'clean_show_doc', 'exec_show_docs',
           'is_frontmatter', 'yml2dict', 'populate_language', 'insert_warning', 'add_show_docs', 'yaml_str',
           'nb_fmdict', 'filter_fm', 'construct_fm', 'insert_frontmatter', 'infer_frontmatter']
