# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/processors.ipynb.
...
# %% ../nbs/processors.ipynb 25
def hide_(cell):
    "Hide cell from output"
    del(cell['source'])

# %% ../nbs/processors.ipynb 27
