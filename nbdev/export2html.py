...
# Cell
def _cite2link(cell):
    '''Creates links from \cite{} to Refenrence section generated by jupyter_latex_envs jupyter extension
    https://github.com/jfbercher/jupyter_latex_envs'''
...
process_cell  = [hide_cells, collapse_cells, remove_widget_state, add_jekyll_notes, escape_latex, _cite2link]
