...
def _show_doc_cell(name, cls_lvl=None):
    show_all = get_config().get('show_all_docments', False)
    return nb_code_cell(f"show_doc({name}{'' if cls_lvl is None else f', default_cls_level={cls_lvl}'}, show_all_docments={show_all}, silent=True)")
