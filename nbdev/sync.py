# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/API/05_sync.ipynb.

# %% auto 0
__all__ = ['absolute_import', 'nbdev_update']

# %% ../nbs/API/05_sync.ipynb 3
from .imports import *
from .config import *
from .maker import *
from .process import *
...
# %% ../nbs/API/05_sync.ipynb 7
_re_import = re.compile("from\s+\S+\s+import\s+\S")

# %% ../nbs/API/05_sync.ipynb 9
