...
__all__ = ['get_name', 'qual_name', 'source_nb', 'relimport2name', 'nbdev_update_lib', 'local_write_tmpl',
           'local_write_tmpls', 'nbdev_diff_nbs', 'nbdev_trust_nbs']
...
# Cell
def local_write_tmpl(tmpl, nms, cfg, dest):
