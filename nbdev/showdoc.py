...
# %% ../nbs/API/08_showdoc.ipynb 60
def showdoc_nm(tree):
    "Get the fully qualified name for showdoc."
    return ifnone(get_patch_name(tree), tree.name)

# %% ../nbs/API/08_showdoc.ipynb 64
def colab_link(path):
