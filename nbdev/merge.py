# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/api/merge.ipynb.

# %% auto 0
__all__ = ['conf_re', 'unpatch', 'nbdev_fix', 'nbdev_merge']

# %% ../nbs/api/merge.ipynb 2
from .imports import *
from .config import *
from .export import *
from .sync import *
