# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/API/13_quarto.ipynb.

# %% ../nbs/API/13_quarto.ipynb 2
...
# %% ../nbs/API/13_quarto.ipynb 12
_def_file_re = '\.(?:ipynb|qmd|html)$'

# %% ../nbs/API/13_quarto.ipynb 13
