# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/09_API/15_migrate.ipynb.

# %% auto 0
__all__ = ['MigrateProc', 'migrate_nb_fm', 'migrate_md_fm', 'nbdev_migrate']

# %% ../nbs/09_API/15_migrate.ipynb 2
from .process import *
...
# %% ../nbs/09_API/15_migrate.ipynb 10
...
# %% ../nbs/09_API/15_migrate.ipynb 11
def _fp_image(d):
...
# %% ../nbs/09_API/15_migrate.ipynb 12
...
# %% ../nbs/09_API/15_migrate.ipynb 15
class MigrateProc(Processor):
    def begin(self): self.nb.frontmatter_ = _fp_convert(self.nb.frontmatter_, self.path)

# %% ../nbs/09_API/15_migrate.ipynb 16
def migrate_nb_fm(path, overwrite=True):
    "Migrate fastpages front matter in notebooks to a raw cell."
    nbp = NBProcessor(path, procs=[FrontmatterProc, MigrateProc, FrontmatterProc])
    nbp.process()
    if overwrite: write_nb(nbp.nb, path)
    return nbp.nb

# %% ../nbs/09_API/15_migrate.ipynb 23
...
# %% ../nbs/09_API/15_migrate.ipynb 31
...
# %% ../nbs/09_API/15_migrate.ipynb 32
def _re_v1():
...
# %% ../nbs/09_API/15_migrate.ipynb 36
def _repl_v1dir(nb):
...
# %% ../nbs/09_API/15_migrate.ipynb 39
...
# %% ../nbs/09_API/15_migrate.ipynb 45
...
# %% ../nbs/09_API/15_migrate.ipynb 46
@call_parse
def nbdev_migrate(
