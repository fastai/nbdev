# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/09_API/10_clean.ipynb.

# %% auto 0
__all__ = ['nbdev_trust', 'clean_nb', 'process_write', 'nbdev_clean', 'clean_jupyter', 'nbdev_install_hooks']

# %% ../nbs/09_API/10_clean.ipynb 2
