...
d = { 'settings': { 'allowed_cell_metadata_keys': '',
  ...
  'syms': { 'nbdev.clean': { 'nbdev.clean.clean_jupyter': 'https://nbdev.fast.ai/clean.html#clean_jupyter',
            ...
            'nbdev.read': { 'nbdev.read.NB': 'https://nbdev.fast.ai/read.html#nb',
                            'nbdev.read.NB.default_exp': 'https://nbdev.fast.ai/read.html#nb.default_exp',
                            'nbdev.read.NB.fmdict': 'https://nbdev.fast.ai/read.html#nb.fmdict',
                            'nbdev.read.NB.print_txt': 'https://nbdev.fast.ai/read.html#nb.print_txt',
                            'nbdev.read.NB.raw_fm_dict': 'https://nbdev.fast.ai/read.html#nb.raw_fm_dict',
                            'nbdev.read.NB.repl_fm': 'https://nbdev.fast.ai/read.html#nb.repl_fm',
                            'nbdev.read.NB.text': 'https://nbdev.fast.ai/read.html#nb.text',
                            'nbdev.read.NB.title_cell': 'https://nbdev.fast.ai/read.html#nb.title_cell',
                            'nbdev.read.NB.update_raw_fm': 'https://nbdev.fast.ai/read.html#nb.update_raw_fm',
