...
d = { 'settings': { 'allowed_cell_metadata_keys': '',
                ...
                'recursive': 'False',
                'requirements': 'fastcore>=1.5.19 execnb>=0.0.10 astunparse ghapi',
                'status': '2',
                'title': 'nbdev',
                'tst_flags': 'notest',
                'user': 'fastai',
  ...
  'syms': { 'nbdev.clean': { 'nbdev.clean.clean_jupyter': 'https://nbdev.fast.ai/clean.html#clean_jupyter',
            ...
            'nbdev.processors': { 'nbdev.processors.add_links': 'https://nbdev.fast.ai/processors.html#add_links',
                                  ...
                                  'nbdev.processors.exec_show_docs.begin': 'https://nbdev.fast.ai/processors.html#exec_show_docs.begin',
