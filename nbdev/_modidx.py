...
d = { 'settings': { 'branch': 'master',
  ...
  'syms': { 'nbdev.clean': { 'nbdev.clean._add_jupyter_hooks': ('api/clean.html#_add_jupyter_hooks', 'nbdev/clean.py'),
            ...
            'nbdev.serve_drv': {},
            'nbdev.showdoc': { 'nbdev.showdoc.AdvHtmlRenderer': ('api/showdoc.html#advhtmlrenderer', 'nbdev/showdoc.py'),
                               'nbdev.showdoc.AdvHtmlRenderer._repr_html_': ( 'api/showdoc.html#advhtmlrenderer._repr_html_',
                                                                              'nbdev/showdoc.py'),
                               'nbdev.showdoc.AdvHtmlRenderer.doc': ('api/showdoc.html#advhtmlrenderer.doc', 'nbdev/showdoc.py'),
                               'nbdev.showdoc.BasicHtmlRenderer': ('api/showdoc.html#basichtmlrenderer', 'nbdev/showdoc.py'),
