# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/API/09a_frontmatter.ipynb.

# %% auto 0
__all__ = ['FrontmatterProc']

# %% ../nbs/API/09a_frontmatter.ipynb 2
from .imports import *
from .process import *
...
# %% ../nbs/API/09a_frontmatter.ipynb 5
...
# %% ../nbs/API/09a_frontmatter.ipynb 6
