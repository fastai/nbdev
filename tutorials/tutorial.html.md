...
> This version is displayed inline: $\sum\_{i=1}^{k+1}i$ . You can
> include text before and after.
...
available to you. For example, this is how you can [incorporate mermaid
charts](https://quarto.org/docs/authoring/diagrams.html):
...
<img src="tutorial_files/figure-commonmark/mermaid-figure-1.png"
style="width:5.82in;height:1.38in" />
