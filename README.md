...
nbdev is on PyPI so you can just run:
``` 
pip install nbdev
```
...
Now, run `jupyter notebook`, and click `00_core.ipynb`. This is where you'll create your first module! Create Jupyter cells as you would in any notebook. For any cells that you want to be included in your python module, type `%nbdev_export` as the first line of the cell. Note that for any new .ipynb that you create, you will need a cell to import `%nbdev_` flags and define the name of the generated module (lib_name/target_module_name.py):

<pre>
from nbdev import *
&percnt;nbdev_default_export target_module_name
</pre>
