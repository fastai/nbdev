...
d = { 'syms': { 'nbprocess.extract_attachments': { 'nbprocess.extract_attachments.ExtractAttachmentsPreprocessor': 'https://nbprocess.fast.ai/extract_attachments#ExtractAttachmentsPreprocessor',
            ...
            'nbprocess.process': { 'nbprocess.process.norm_quarto': 'https://nbprocess.fast.ai/process#norm_quarto',
  ...
  'settings': { 'host': 'github',
                ...
                'user': 'fastai',
                'version': '0.0.3'},
  'syms': { 'nbprocess.blog': { 'nbprocess.blog.cat_slug': 'https://nbprocess.fast.ai/blog#cat_slug',
                                'nbprocess.blog.file_slug': 'https://nbprocess.fast.ai/blog#file_slug',
                                'nbprocess.blog.migrate_nb_fm': 'https://nbprocess.fast.ai/blog#migrate_nb_fm'},
            ...
            'nbprocess.processors': { 'nbprocess.processors.DEFAULT_FM_KEYS': 'https://nbprocess.fast.ai/processors#DEFAULT_FM_KEYS',
                                      ...
                                      'nbprocess.processors.rm_header_dash': 'https://nbprocess.fast.ai/processors#rm_header_dash',
                                      'nbprocess.processors.strip_ansi': 'https://nbprocess.fast.ai/processors#strip_ansi'},
            'nbprocess.read': { 'nbprocess.read.NBRunner': 'https://nbprocess.fast.ai/read#NBRunner',
                                'nbprocess.read.NBRunner.exec_nb': 'https://nbprocess.fast.ai/read#NBRunner.exec_nb',
                                'nbprocess.read.NBRunner.run': 'https://nbprocess.fast.ai/read#NBRunner.run',
                                'nbprocess.read.NbCell': 'https://nbprocess.fast.ai/read#NbCell',
                                'nbprocess.read.NbCell.parsed_': 'https://nbprocess.fast.ai/read#NbCell.parsed_',
                                'nbprocess.read.NbCell.set_source': 'https://nbprocess.fast.ai/read#NbCell.set_source',
                                'nbprocess.read.add_init': 'https://nbprocess.fast.ai/read#add_init',
                                'nbprocess.read.basic_export_nb': 'https://nbprocess.fast.ai/read#basic_export_nb',
            ...
            'nbprocess.showdoc': { 'nbprocess.showdoc.BasicHtmlRenderer': 'https://nbprocess.fast.ai/showdoc#BasicHtmlRenderer',
                                   'nbprocess.showdoc.BasicMarkdownRenderer': 'https://nbprocess.fast.ai/showdoc#BasicMarkdownRenderer',
                                   'nbprocess.showdoc.ShowDocRenderer': 'https://nbprocess.fast.ai/showdoc#ShowDocRenderer',
                                   'nbprocess.showdoc.get_name': 'https://nbprocess.fast.ai/showdoc#get_name',
                                   'nbprocess.showdoc.qual_name': 'https://nbprocess.fast.ai/showdoc#qual_name',
                                   'nbprocess.showdoc.show_doc': 'https://nbprocess.fast.ai/showdoc#show_doc',
                                   'nbprocess.showdoc.showdoc_nm': 'https://nbprocess.fast.ai/showdoc#showdoc_nm'},
            'nbprocess.sync': { 'nbprocess.sync.absolute_import': 'https://nbprocess.fast.ai/sync#absolute_import',
                                'nbprocess.sync.nb2dict': 'https://nbprocess.fast.ai/sync#nb2dict',
                                'nbprocess.sync.nb2str': 'https://nbprocess.fast.ai/sync#nb2str',
                                'nbprocess.sync.nbprocess_update': 'https://nbprocess.fast.ai/sync#nbprocess_update',
                                'nbprocess.sync.write_nb': 'https://nbprocess.fast.ai/sync#write_nb'},
            'nbprocess.test': { 'nbprocess.test.nbprocessTestFailure': 'https://nbprocess.fast.ai/test#nbprocessTestFailure',
