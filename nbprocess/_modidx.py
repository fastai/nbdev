...
d = { 'settings': { 'audience': 'Developers',
  ...
  'syms': { 'nbprocess.clean': { 'nbprocess.clean.clean_nb': 'https://nbprocess.fast.ai/clean#clean_nb',
            ...
            'nbprocess.migrate': { 'nbprocess.migrate.cat_slug': 'https://nbprocess.fast.ai/migrate#cat_slug',
                                   'nbprocess.migrate.file_slug': 'https://nbprocess.fast.ai/migrate#file_slug',
                                   'nbprocess.migrate.md_fmdict': 'https://nbprocess.fast.ai/migrate#md_fmdict',
                                   'nbprocess.migrate.migrate_md_fm': 'https://nbprocess.fast.ai/migrate#migrate_md_fm',
            ...
            'nbprocess.process': { 'nbprocess.process.NBProcessor': 'https://nbprocess.fast.ai/process#NBProcessor',
                                   ...
                                   'nbprocess.process.norm_quarto': 'https://nbprocess.fast.ai/process#norm_quarto',
