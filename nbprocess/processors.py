...
# %% auto 0
__all__ = ['DEFAULT_FM_KEYS', 'cell_lang', 'add_links', 'strip_ansi', 'hide_', 'hide_line', 'filter_stream_', 'clean_magics',
           'lang_identify', 'rm_header_dash', 'rm_export', 'clean_show_doc', 'exec_show_docs', 'populate_language',
           'insert_warning', 'add_show_docs', 'is_frontmatter', 'nb_fmdict', 'construct_fm', 'insert_frontmatter',
           'infer_frontmatter']
