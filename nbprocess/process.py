...
# %% auto 0
__all__ = ['langs', 'first_code_ln', 'extract_directives', 'opt_set', 'instantiate', 'NBProcessor']
...
#bash|html|javascript|js|latex|markdown|perl|ruby|sh|svg
...
class NBProcessor:
    ...
    def __init__(self, path=None, procs=None, preprocs=None, postprocs=None, nb=None, debug=False, rm_directives=True, process=False):
        ...
        self.lang = self.nb.metadata.kernelspec.language
