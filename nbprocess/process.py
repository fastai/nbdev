...
# %% auto 0
__all__ = ['norm_quarto', 'first_code_ln', 'extract_directives', 'opt_set', 'instantiate', 'NBProcessor']
...
def extract_directives(cell, remove=True):
    ...
    if cell.source:
        ...
        if remove:
            ...
            cell['source'] = ''.join([norm_quarto(o) for o in pre if _quarto_re.match(o)] + ss[first_code:])
