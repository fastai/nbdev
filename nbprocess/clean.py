# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/07_clean.ipynb.

# %% auto 0
__all__ = ['clean_nb', 'clean_nbs']
...
def _clean_write(f_in, f_out=None, clear_all=False):
...
def clean_nbs(
    ...
    for f in globtastic(fname, file_glob='*.ipynb', skip_folder_re='^[_.]'):
        _clean_write(f, clear_all=clear_all)
